...
function upper_count($str)
{
    ...
    {
        if (ucfirst($word) === $word and strtoupper($word) !== $word)
        {
            $i++;
            //$sonad[]= $word;
        }
...
/*
1. Leia kõik sõnad, mis algavad suure tähega.
2. Ühenda üksteisega kõrvuti olevad sõnad
3. Ei sisalda rohkem kui 1 suurt tähte. Ei tohi olla kahe numbri vahel.
4. Pärast .?! ainult siis kui 2 järgnevat sõna on ka suure tähega
5. Eemalda duplidaadid*/
?>
